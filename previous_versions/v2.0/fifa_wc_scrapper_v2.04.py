...
Description: This program scraps online tables and data related to the
      ...
      To do: > Finish '02 match scrapper
               - Scrap group stage data for location and dates
               - Format 'Stage' field
...
def matches_scrapper(soup2, wc, matches_ds): # -------------------------------
    ...
    # Group = list(itl.chain.from_iterable(itl.repeat(i, 16) for i in Group))

    # wc = ['Korea/Japan 2002']
    # wc = list(itl.chain.from_iterable(itl.repeat(i, 16) for i in wc))
